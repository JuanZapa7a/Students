...
\chapter{Chapter \thechapter ~ Title} % The asterisk leaves out this chapter from the table of contents
\label{cha:first}
\begin{quote}
\textit{In this chapter, I describe a summing of this chapter. \lipsum[1].} \newline
\end{quote}
...
\begin{marginfigure}
\includegraphics[width=\linewidth]{Chapter1/helix.pdf}
...
\begin{figure*}[h]
\includegraphics[width=\linewidth]{Chapter1/sine.pdf}
